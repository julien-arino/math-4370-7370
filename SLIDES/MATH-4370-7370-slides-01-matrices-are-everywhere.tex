...
% \end{align}
% \end{subequations}
% where $B:\IR\to\IR^n$ a smooth function on $\IR$, and let $e^{A(t-t_0)}$ be matrix exponential associated to the homogeneous system $\bx'=A\bx$. Then the solution $\phi$ of \eqref{sys:lin_nonlin} is given by
% \begin{equation}
